  ...
  return (
    <div className="page-container">
      <div className="admin-header">
        <div>
          <h2>{user?.role === "ADMIN" ? t("adminDashboard") : t("organizerDashboard")}</h2>
          <p className="admin-greeting">{t("navGreeting")} {user?.username || (user?.role === "ADMIN" ? t("admin") : t("organizer"))}</p>
        </div>
      ...
      <h3 className="admin-section-title">{t("allEvents")}</h3>
